 ...
 */
public class Xoroshiro128pp implements RndInt64 {

    private static final int LSFT   = 21;
    private static final int ROTL_0 = 17;
    private static final int ROTL_1 = 49;
    private static final int ROTL_2 = 28;
    ...
    public long nextInt64() {
        ...
        final long sum01 = tmp0 + tmp1;

        final long result = Long.rotateLeft(sum01, ROTL_0) + tmp0;

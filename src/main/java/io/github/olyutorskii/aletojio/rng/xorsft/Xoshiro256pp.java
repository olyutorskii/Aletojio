 ...
 */
public class Xoshiro256pp implements RndInt64 {

    private static final int LSFT   = 17;
    private static final int ROTL_0 = 23;
    ...
    public long nextInt64() {
        ...
        final long sum03 = tmp0 + tmp3;
        final long lsft1 = tmp1 << LSFT;

        final long result = Long.rotateLeft(sum03, ROTL_0) + tmp0;
